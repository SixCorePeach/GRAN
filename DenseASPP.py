...
class DenseASPP(nn.Module):
    ...
    * output_scale can only set as 8 or 16
    """
    def __init__(self, model_cfg, n_class=2, output_stride=8, feature_scale=4, is_deconv=True, is_batchnorm=True,
        ...
        self.classification = nn.Sequential(
            ...
            nn.Conv2d(in_channels=num_features, out_channels=2, kernel_size=1, padding=0),
            nn.Sigmoid(),
