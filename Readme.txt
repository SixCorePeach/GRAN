...
To be honest，in order to improve our model generation, we use the GAN to let GIAN to learning the distrubution of lesion, and get more steady result as the ISIC_result.png.
